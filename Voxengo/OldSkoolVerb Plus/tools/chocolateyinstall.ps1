...
$checksum       = '58b38e05e4107101782845a830eae84fa1dfec7095bbb9a83d5b07428ee5bcfd'
$url            = 'https://www.voxengo.com/files/VoxengoOldSkoolVerbPlus_17_Win32_64_VST_VST3_AAX_setup.exe'
