...
$checksum       = '1f459644e4ccf051bf281571d76278f4822a00b7f3d896b5a6ccdf73b1016c37'
$url            = 'https://www.voxengo.com/files/VoxengoTempoDelay_29_Win32_64_VST_VST3_AAX_setup.exe'
