...
$checksum       = 'a60eb02db31a91edea79df5c98dc4d088fe43d5e38ac46fb3635be8c128eaec7'
$url            = 'https://www.voxengo.com/files/VoxengoSoundDelay_115_Win32_64_VST_VST3_AAX_setup.exe'
