...
$revision = '16742'
$urls = (
    "https://u-he.com/downloads/releases/ColourCopy_${versionWithoutDots}_${revision}_Win.zip", 
    "https://u-he.com/downloads/release-archive//colourcopy//ColourCopy_${versionWithoutDots}_${revision}_Win.zip"
)
...
$zipArgs = @{
  ...
  checksum      = 'ee2bbdfb2fb0c61779af9b378fb52ffdb9f393e09bdc76316073ec8a876ecd8e'
  checksumType  = 'sha256'
}
