...
$revision = '16518'
$urls = (
    "https://u-he.com/downloads/releases/Bazille_${versionWithoutDots}_${revision}_Win.zip", 
    "https://u-he.com/downloads/release-archive//bazille//Bazille_${versionWithoutDots}_${revision}_Win.zip"
)
...
$zipArgs = @{
  ...
  checksum      = 'c09b04c4fefd064de350039546217aa386aaa194ee14e56fa2c3554b06c6a209'
  checksumType  = 'sha256'
}
