...
$revision = '15664'
$urls = (
    "https://u-he.com/downloads/releases/Filterscape_${versionWithoutDots}_${revision}_Win.zip", 
    "https://u-he.com/downloads/release-archive//filterscape//Filterscape_${versionWithoutDots}_${revision}_Win.zip"
)
...
$zipArgs = @{
  ...
  checksum      = '69fe3a5533c02a851147d94f05e492a12385ff7f49470863cfce0d9d0303d511'
  checksumType  = 'sha256'
}
