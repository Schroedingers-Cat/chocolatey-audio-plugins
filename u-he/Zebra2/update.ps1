...
$company = 'u-he'
$url32        = 'https://uhedownloads-heckmannaudiogmb.netdna-ssl.com/releases/Zebra2_29_9436_Win.zip'
$releases = 'https://u-he.com/products/zebra2/'
$checksum32 = '7c7e2b22a6beca1a71d6d7ada751530986e6c248a93f04abdb4273ec846faed9'
...
function CreateRegistryObjects () { $global:regKeys =
  ...
  @{'path'="HKLM:\\SOFTWARE\chocolatey\$env:ChocolateyPackageName"; 'key'="CompanyPath";          'value'="$companyPath";                 'bit'=64,32;  'validpp'="NoVst2x64", "NoVst2x86", "NoVst3x64", "NoVst3x86", "NoAaxx86", "NoAaxx64"},
  @{'path'="HKLM:\\SOFTWARE\chocolatey\$env:ChocolateyPackageName"; 'key'="Vst64Path";            'value'="$vst2Path";                    'bit'=64;     'validpp'="NoVst2x64"},
  @{'path'="HKLM:\\SOFTWARE\chocolatey\$env:ChocolateyPackageName"; 'key'="Vst32Path";            'value'="$vst2x86BitAware";             'bit'=64,32;  'validpp'="NoVst2x86"},
  @{'path'="HKLM:\\SOFTWARE\chocolatey\$env:ChocolateyPackageName"; 'key'="UserFolderPath";       'value'="$userFolderPath";              'bit'=64,32;  'validpp'="Always"; 'dropIfNull'=@("$userFolderPath")},
