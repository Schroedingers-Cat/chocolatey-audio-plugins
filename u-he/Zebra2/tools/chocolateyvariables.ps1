...
$urlAlternative = "https://u-he.com/downloads/release-archive//zebra2//Zebra_Legacy_${versionWithoutDots}_${revision}_Win.zip"
...
$unzInstPath = "Zebra_Legacy_${versionWithoutDots}_${revision}_Win\01 Zebra2\Zebra${versionWithoutDots}Winstaller.exe"
$zipSuffix = "Win.zip"
