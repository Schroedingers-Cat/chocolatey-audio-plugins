...
$urlAlternative = "https://u-he.com/downloads/release-archive//repro//Repro_${versionWithoutDots}_${revision}_Win.zip"
$releases = 'https://u-he.com/products/repro/'
$checksum = '7053934faf658a7c66a2797634e45008ddfee5f25981eea1ef19612f1f31bda2'
