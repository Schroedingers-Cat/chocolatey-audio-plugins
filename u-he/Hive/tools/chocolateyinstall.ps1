...
$revision = '16520'
$urls = (
    "https://u-he.com/downloads/releases/Hive_${versionWithoutDots}_${revision}_Win.zip", 
    "https://u-he.com/downloads/release-archive//hive//Hive_${versionWithoutDots}_${revision}_Win.zip"
)
...
$zipArgs = @{
  ...
  checksum      = '12d2ba4c3bc5da910f5c942e6e273eeb839f73cf234983ea6d8303407b32bd72'
  checksumType  = 'sha256'
}
