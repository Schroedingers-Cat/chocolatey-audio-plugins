...
$revision = '15721'
$urls = (
    "https://u-he.com/downloads/releases/Satin_${versionWithoutDots}_${revision}_Win.zip", 
    "https://u-he.com/downloads/release-archive//satin//Satin_${versionWithoutDots}_${revision}_Win.zip"
)
...
$zipArgs = @{
  ...
  checksum      = '2be9522b88d7a3525c7b441708622b9152469aef00b564b368acfedff2f8f371'
  checksumType  = 'sha256'
}
