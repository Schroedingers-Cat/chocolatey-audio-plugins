...
$revision = '16960'
$urls = (
    "https://u-he.com/downloads/releases/Presswerk_${versionWithoutDots}_${revision}_Win.zip", 
    "https://u-he.com/downloads/release-archive//presswerk//Presswerk_${versionWithoutDots}_${revision}_Win.zip"
)
...
$zipArgs = @{
  ...
  checksum      = 'cfb6f405d073bc9ea10b02298157ace0855eb92768413a5b9cda942bd3cf369b'
  checksumType  = 'sha256'
}
