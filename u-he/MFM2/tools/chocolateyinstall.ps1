...
$revision = '16742'
$urls = (
    "https://u-he.com/downloads/releases/MFM2_${versionWithoutDots}_${revision}_Win.zip", 
    "https://u-he.com/downloads/release-archive//mfm2//MFM2_${versionWithoutDots}_${revision}_Win.zip"
)
...
$zipArgs = @{
  ...
  checksum      = '61445873d857345156339501218f1ae93064138297d1d9f5e9213bb7b531f154'
  checksumType  = 'sha256'
}
