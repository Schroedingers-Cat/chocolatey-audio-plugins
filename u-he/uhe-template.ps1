...
For example:
``````powershell
choco install uhe-package --package-parameters """'/DataPath:C:\ProgramData\u-he\'"""
``````
"@
...
"
    ...
    @{
        ...
        Version       = "1.0.0"
        Revision      = "12091"
        Tags          = "audio vst synthesizer repro-1 repro-5 aax admin trial"
        Checksum      = "20f69db8f978efa1efe46b6c4215c314837c18621a6e9e80a66c3a39ad55aa7c"
...
"
    ...
    @{
        ...
        NoNks         = $true
        Description   = "Uhbik: Subtle to spectacular
