...
$releases = "https://[[AuthorLowerNowhite]].com/products_[[PackageNameLower]].php"
$url32 = 'https://[[AuthorLowerNowhite]].com/dl/[[PackageName]]_v[[Version]]/[[PackageName]]Win_v[[Version]].zip'
