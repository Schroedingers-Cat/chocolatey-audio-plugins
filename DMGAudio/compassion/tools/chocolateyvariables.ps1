...
$company = 'DMGAudio'
$url32        = 'https://dmgaudio.com/dl/Compassion_v1.24/CompassionWin_v1.24.zip'
$releases = 'https://dmgaudio.com/products_compassion.php'
$checksum32 = '11d2ef860643a3a9c32e0662a5b3e0bcd3df50739551fff44b3f1ef63fb674a9'
