...
$company = 'DMGAudio'
$url32        = 'https://dmgaudio.com/dl/EQuilibrium_v1.64/EQuilibriumWin_v1.64.zip'
$releases = 'https://dmgaudio.com/products_equilibrium.php'
$checksum32 = 'd3490dac0a2a4dae09202c3f8e989140f79918545308884467a10d6722d5689e'
