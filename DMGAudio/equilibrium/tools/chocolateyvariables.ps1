...
$company = 'DMGAudio'
$url32        = 'https://dmgaudio.com/dl/EQuilibrium_v1.60/EQuilibriumWin_v1.60.zip'
$releases = 'https://dmgaudio.com/products_equilibrium.php'
$checksum32 = 'b6266943f28e9ab2d6a1b7bbd8163396d4dd45f72de41d9563704739ecdcf791'
