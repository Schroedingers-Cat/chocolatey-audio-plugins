...
$company = 'DMGAudio'
$url32        = 'https://dmgaudio.com/dl/EQuality_v1.35/EQualityWin_v1.35.zip'
$releases = 'https://dmgaudio.com/products_equality.php'
$checksum32 = '3de23cecebc4006d9020167af4e2eaeac6e704995d6187f7f56a08e641300a52'
